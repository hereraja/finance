               ...
               <!--   <button id="btnExport" class="btn btn-primary" onclick="exportReportToExcel(this)">EXPORT EXCEL</button> !-->
                      ...
                      <tr>
                        ...
                        <table style="width: 100%;">
                            ...
                            $ctot_dr =0.00;$ctot_cr =0.00;
                                if($trail_balnce){
                                    foreach($mngre as  $mna){
                                ?>
							    <tr><td></td><td><b><?=$mna->mng_name?></b></td></tr>
                    ...
                    <td style="width: 50%;">        
                        ...
                        <table style="width: 100%;">
                            ...
                            <?php
                                if($trail_balnce){
												 foreach($mngrr as  $mnr){					
                                ?>
							     <tr><td><b><?=$mnr->mng_name?></b></td></tr>
                                <?php   foreach($trail_balnce as $tb){ 
									if($mnr->mngr_id == $tb->mngr_id) {
									$type = $tb->type; 
                                    if($tb->op_dr+$tb->op_cr+$tb->dr_amt+$tb->cr_amt!=0) {?>
                                <tr class="rep">
                    ...
                    <?php 
                      ...
                      <tr style="font-weight: bold;"> 
                          <td style="text-align: right;">Net Profit:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=number_format(abs($calamt),2)?></td>
                       ...
                       <?php      }else {  ?>
                        ...
                        <tr style="font-weight: bold;"> 
                        <td style="text-align: right;"> </td>
                          <td style="text-align:right;">Net Loss: &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=number_format(abs($calamt),2)?></td>
                          </tr>

                          <tr style="font-weight: bold;">     
                            <td style="text-align: right;">Total:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=number_format(abs($ctot_dr),2)?></td>
                            <td style="text-align:right;"><?=number_format((abs($ctot_cr)+abs($calamt)),2)?></td>
                         </tr>
                        <?php } ?>
